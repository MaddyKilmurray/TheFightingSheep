...
public class Movie {
    ...
    public Movie(Awards awards, Imdb imdb, Instant lastUpdated, Integer numMflixComments, String title, String type, Integer year) {
        this.awards = awards;
        this.imdb = imdb;
